...
export default function BookMovieDetailPage({ params }: { params: { id: string } }) {
  // Get the book/movie item
  const bookMovie = getContentById<BookMovieItem>("books-movies", params.id)
  ...
  const relatedItems = getRelatedContent<BookMovieItem>("books-movies", params.id, 2)
