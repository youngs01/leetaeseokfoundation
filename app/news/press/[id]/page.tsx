...
export default function PressDetailPage({ params }: { params: any }) {
  const { id } = React.use(params as any)

  // Get the press item
  const press = getContentById<PressItem>("press", id)
  ...
  const relatedPress = getRelatedContent<PressItem>("press", id, 2)
