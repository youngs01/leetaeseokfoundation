...
export default function ThankYouLetterDetailPage({ params }: { params: any }) {
  const { id } = React.use(params as any)

  // Get the letter item
  const letter = getContentById<ThankYouLetterItem>("letter", id)
  ...
  // Get related letters
  const relatedLetters = getRelatedContent<ThankYouLetterItem>("letter", id, 2)
